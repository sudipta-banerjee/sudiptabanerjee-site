    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-slate-200">
      ...
      <nav className="max-w-3xl mx-auto px-6 py-10 flex justify-between items-center">
        ...
        <div className="space-x-6 text-sm font-medium text-slate-500">
          ...
          <Link href="#blog" className="hover:text-slate-900 transition-colors">Writing</Link>
          <Link href="#contact" className="hover:text-slate-900 transition-colors">Connect</Link>
        </div>
      </nav>
      ...
      <main className="max-w-3xl mx-auto px-6">
        ...
        <section id="research" className="py-16 border-t border-slate-100">
          ...
          <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
            ...
            <div className="text-sm font-medium text-blue-600 cursor-pointer hover:underline">Read Abstract &rarr;</div>
          </div>
        </section>
